...
//             <Nav.Link onClick={() => setSelectedComponent('Dashboard')}>
//               Dashboard
//             </Nav.Link>
//             <Nav.Link onClick={() => setSelectedComponent('AccountDetails')}>
//               Account Details
//             </Nav.Link>
//             <Nav.Link onClick={() => setSelectedComponent('ChangePassword')}>
//               Change Password
//             </Nav.Link>
//             <Nav.Link onClick={() => setSelectedComponent('MyBookCollection')}>
//               My Book Collection
//             </Nav.Link>
//             <Nav.Link onClick={() => setSelectedComponent('PublishBook')}>
//               Publish Book
//             </Nav.Link>
//             <Nav.Link onClick={() => setSelectedComponent('Settings')}>
//               Settings
//             </Nav.Link>
//           </Nav>
//         </Col>
